...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
        ...
        <h2 class="text-2xl font-semibold text-gray-700 text-center mb-6">Buat Data Bio</h2>
        <form action="store.php" method="POST" class="space-y-4">
            <div>
                ...
                <div class="flex items-center border rounded-lg px-3 py-2 bg-gray-50 focus-within:ring-2 focus-within:ring-blue-400">
                    ...
                    <input type="text" name="nama" id="nama" class="w-full bg-transparent focus:outline-none" placeholder="Masukkan nama lengkap">
                </div>
            </div>
            <div>
                ...
                <div class="flex items-center border rounded-lg px-3 py-2 bg-gray-50 focus-within:ring-2 focus-within:ring-blue-400">
                    ...
                    <input type="number" name="umur" id="umur" class="w-full bg-transparent focus:outline-none" placeholder="Masukkan umur">
                </div>
            </div>
            <div>
                ...
                <div class="flex border rounded-lg px-3 py-2 bg-gray-50 focus-within:ring-2 focus-within:ring-blue-400">
                    <textarea name="bio" id="bio" rows="5" class="w-full bg-transparent focus:outline-none" placeholder="Tulis bio singkat"></textarea>
                </div>
            </div>
